...
namespace CRMDuvg.Controllers
{
    public class TelefonosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "TelefonoId,Numero,Tipo,Principal")] Telefono telefono)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "TelefonoId,Numero,Tipo,Principal")] Telefono telefono)
        {
            if (ModelState.IsValid)
            {
